...
export async function handleVerification({
	...
	void sendEmail({
		...
		subject: 'Wochlife email changed',
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Wochlife Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your Wochlife email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your Wochlife email has been
						changed.
					</E.Text>
				</p>
				<p>
