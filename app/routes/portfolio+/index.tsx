			...
			<div className="custom-content-box-height overflow-y-scroll">
				<div>
					...
					<div>
						<div className="mb-8">
							<p className="mb-2">
								My freelance work for clients:
							</p>
							<Link to="freelance" prefetch="intent">
								<Button size="sm" className="capitalize" variant="highlight-secondary">
									freelance
								</Button>
							</Link>
						</div>
						...
						<div className="mb-8">
							<p className="mb-2">
								Find out more about me personally.
							</p>
